...
require (
	...
	github.com/pulumi/pulumi-rancher2/sdk/v2 v2.1.0 // indirect
	github.com/pulumi/pulumi-random/sdk/v2 v2.1.0 // indirect
	github.com/pulumi/pulumi-vsphere/sdk/v2 v2.3.0 // indirect
